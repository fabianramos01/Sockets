...
public class ConstantList {
	...
	public static final String SERVER_HOUR = "Hora del servidor";
	public static final String SERVER_FILE = "Archivo del servidor";
	public static final String DOWNLOAD_FILE_OK = "Archivo descargado";
